...
void std_inner_product() {
  ...
  int costum_result = std::inner_product(std::begin(v1), std::end(v1), std::begin(v2), 0, std::plus<int>(), std::multiplies<int>());
  int costum_result_2 = std::inner_product(std::begin(v1), std::end(v1), std::begin(v2), 1,  std::multiplies<int>(), std::plus<int>());
